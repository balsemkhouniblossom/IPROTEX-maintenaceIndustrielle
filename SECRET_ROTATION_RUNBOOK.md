...
> **Restored for the Phase 2 corrective release candidate.** The incident
> remains open. Dates and mirror paths below are historical evidence from the
> last recorded verification and must be revalidated by the repository owner
> before any destructive history operation. Nothing in this restoration is a
> claim that credentials were rotated or exposed sessions were invalidated.
