  ...
  return (
    ...
    >
      ...
      {hasLongSleeves ? (
        ...
        <path d="M23 112c1-15 6-25 16-31l9 10-5 21H23Zm74 0c-1-15-6-25-16-31L72 91l5 21h20Z" fill={roleConfig.uniform} />
      )}
      ...
      {roleConfig.helmet ? (
        ...
        <path d="M37 42c2-18 10-28 23-28 14 0 23 10 24 29-7-8-15-12-24-12-8 0-16 4-23 11Z" fill="#26384b" />
      )}
      ...
      <g aria-hidden="true">
        ...
        {role === "TECHNICIAN" ? (
          <path d="M73 83l10 10M80 82a4 4 0 0 0 4 5l-5-5a4 4 0 0 0-5 4l5 5" fill="none" stroke="#c2410c" strokeWidth="1.8" strokeLinecap="round" />
        ) : (
          <path d="M74 88h8M78 84v8" stroke={roleConfig.uniform} strokeWidth="2" strokeLinecap="round" />
        )}
      </g>
